        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-1 main">
                    ...
                    <div>
                       <a href="Home.html"><button class="btn btn-primary btn-xl js-scroll-trigger">Regresar</button></a>
                        <a href="cursosMatricular.jsp"><button class="btn btn-primary btn-xl js-scroll-trigger">Matricular</button></a>
                    </div>
